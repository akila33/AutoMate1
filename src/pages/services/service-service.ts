...
export class ServiceServiceProvider {
  ...
  private serviceListUrl: string = "http://automate33.tk/service/service/read.php";
  private createServiceUrl: string = "http://automate33.tk/service/service/create.php";
