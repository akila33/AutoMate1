...
export class ProblemsServiceProvider {
  ...
  private problemListUrl: string = "http://automate33.tk/service/problems/read.php";
  private problem1ListUrl: string = "http://automate33.tk/service/problems/read1.php";
